...
4. Compile dependencies with the following commands (in the root directory)
    ...
    ```shell
    cd src/GameEngine
    g++ -c -O3 -DNDEBUG consts.cpp GameEngine.cpp GamePlayer.cpp HumanPlayer.cpp utils.cpp -I"../../src" -I"../../chess-library/src" -I"../../SFML-2.6.0/include" -DSFML_STATIC
    cd ../../src/Raphael
    g++ -c -O3 -DNDEBUG consts.cpp History.cpp Killers.cpp SEE.cpp Transposition.cpp -Isrc -Ichess-library/src -I"../../src" -I"../../chess-library/src" -I"../../SFML-2.6.0/include" -DSFML_STATIC
    cd ../../
    ```
