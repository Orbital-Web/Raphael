...
#include <Raphael/RaphaelParam_v1.8.hpp>
#include <chess.hpp>
#include <chrono>
#include <climits>
#include <iomanip>
...
protected:
    ...
    v1_8_params params;       // search parameters
    // ponder
...
public:
    ...
    v1_8(string name_in): GamePlayer(name_in), tt(DEF_TABLE_SIZE) { PMASK::init_pawnmask(); }
    // and with engine options
    v1_8(string name_in, EngineOptions options): GamePlayer(name_in), tt(options.tablesize) {
        PMASK::init_pawnmask();
    }
