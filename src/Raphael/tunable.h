...
Tunable(NMP_REDUCTION, 512, 32, 1024, true);
Tunable(NMP_DEPTH_SCALE, 25, 1, 128, true);
Tunable(NMP_EVAL_SCALE, 82, 1, 128, true);
Tunable(NMP_EVAL_MAX, 384, 32, 1024, true);
Tunable(NMP_IMPROVING, 128, 32, 384, true);
