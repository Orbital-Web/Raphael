...
Tunable(HISTORY_BONUS_DEPTH_SCALE, 276, 128, 512);
Tunable(HISTORY_BONUS_OFFSET, 430, 128, 768);
Tunable(HISTORY_BONUS_MAX, 2540, 1024, 4096);
Tunable(HISTORY_PENALTY_DEPTH_SCALE, 334, 128, 512);
Tunable(HISTORY_PENALTY_OFFSET, 147, 128, 768);
Tunable(HISTORY_PENALTY_MAX, 1236, 1024, 4096);

Tunable(CAPTHIST_BONUS_DEPTH_SCALE, 144, 128, 512);
Tunable(CAPTHIST_BONUS_OFFSET, 196, 128, 768);
Tunable(CAPTHIST_BONUS_MAX, 2452, 1024, 4096);
Tunable(CAPTHIST_PENALTY_DEPTH_SCALE, 152, 128, 512);
Tunable(CAPTHIST_PENALTY_OFFSET, 221, 128, 768);
Tunable(CAPTHIST_PENALTY_MAX, 2090, 1024, 4096);
