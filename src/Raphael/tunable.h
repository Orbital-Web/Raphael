...
Tunable(HISTORY_BONUS_DEPTH_SCALE, 280, 128, 512);
Tunable(HISTORY_BONUS_OFFSET, 430, 128, 768);
Tunable(HISTORY_BONUS_MAX, 2500, 1024, 4096);
Tunable(HISTORY_PENALTY_DEPTH_SCALE, 340, 128, 512);
Tunable(HISTORY_PENALTY_OFFSET, 160, 128, 768);
Tunable(HISTORY_PENALTY_MAX, 1250, 1024, 4096);

Tunable(CAPTHIST_BONUS_DEPTH_SCALE, 150, 128, 512);
Tunable(CAPTHIST_BONUS_OFFSET, 200, 128, 768);
Tunable(CAPTHIST_BONUS_MAX, 2500, 1024, 4096);
Tunable(CAPTHIST_PENALTY_DEPTH_SCALE, 150, 128, 512);
Tunable(CAPTHIST_PENALTY_OFFSET, 200, 128, 768);
